...
public class ItemBuilder {
    ...
    public ItemBuilder removeLores() {
        this.lore.clear();
        return this;
    }
    ...
    public ItemBuilder addLores(List<String> lores) {
        for (String x : lores)
            this.lore.add(ChatUtil.fixColor(x));
        return this;
    }
    ...
    public ItemStack addEnchantment(Enchantment damageAll, int level) {
        this.enchants.put(damageAll, level);
        return null;
    }
}
